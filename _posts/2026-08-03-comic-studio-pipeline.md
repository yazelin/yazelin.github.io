---
layout: post
title: "小說變漫畫的第一關：同一個房間，每一格都要是同一個房間"
subtitle: "comic-studio 是一個純前端的漫畫工作台，章節文字進去、可安裝的 PWA 漫畫站出來。前兩話做下來我只解到第一關：角色跟空間不再每格重擲。離「畫得對的漫畫」還差很多關，這篇也把還沒解的那些寫出來。"
date: 2026-08-03
categories: [AI]
...
**驗收還是靠我的眼睛。** 排版那層有完稿檢查，抓的是氣泡忘了放、字太小、拖出畫面這種形式問題。畫面本身對不對，現在完全靠我一格一格看。我在[另一部社群漫畫]({% post_url 2026-08-01-neko-tensei-auto-episode %})那條線上已經做到出圖後自動逐頁驗收，comic-studio 這邊還沒接。
