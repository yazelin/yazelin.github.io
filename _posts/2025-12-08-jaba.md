...
![jaba](https://github.com/yazelin/yazelin.github.io/releases/download/blog-images/images-jaba-jaba-icon-32.png) [呷爸 jaba](https://github.com/yazelin/jaba) 是一個 AI 驅動的午餐訂便當系統，透過 LINE Bot 讓群組點餐變得簡單直覺。
...
![系統架構](https://github.com/yazelin/yazelin.github.io/releases/download/blog-images/images-jaba-system-architecture.jpg)
...
![看板頁面](https://github.com/yazelin/yazelin.github.io/releases/download/blog-images/images-jaba-03-dashboard-summary.jpg)

顯示所有群組的訂單、美食評論區（LINE 群組對話）、LINE QRCode 方便加入呷爸好友。

**超級管理員頁面**：

![管理頁面](https://github.com/yazelin/yazelin.github.io/releases/download/blog-images/images-jaba-02-manager-page-overview.jpg)
...
![差異預覽](https://github.com/yazelin/yazelin.github.io/releases/download/blog-images/images-jaba-06-menu-diff-preview.jpg)
