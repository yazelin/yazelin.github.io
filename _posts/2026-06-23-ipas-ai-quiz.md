...
subtitle: "兩天、55 個 commit、790 題——一個只為自己考試做的刷題站,順手變成一層誰都能接的開放題庫。"
date: 2026-06-23
categories: [AI, 開發工具]
...
兩天後它變成了這樣:790 題、純前端、可裝成 App、會每天推播提醒我念書。git log 攤開來看,所有 commit 都落在 **2026-06-22 跟 06-23 兩天**(共 55 個 commit)。下面就順著「先把自己的需求做完、再把它打開」這條線記錄。
