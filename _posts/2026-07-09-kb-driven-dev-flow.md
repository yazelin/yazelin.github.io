...
排練的只有這一段，流程本身完全是日常。我們早就用這種方式開發過很多次了，這次只是把平常散在好幾天裡的事，濃縮成幾張截圖能看完的一輪，方便丟進 LINE 群組分享。
...
最後補一個現況：這隻 LINE 機器人已經住在多個客戶的群組裡，需求在群組裡收、報告在群組裡交，上面那條迴圈天天在跑。如果你的團隊也想把規格和報告收進同一個地方，不用等什麼大平台，一個 markdown 資料夾加一支小 CLI 就夠起步了。
