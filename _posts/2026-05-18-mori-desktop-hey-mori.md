...
兩個月前我寫了 [asr-ime-fcitx]({% post_url 2026-02-14-asr-ime-fcitx %}) 這個 Fcitx5 原生語音輸入法，[v2]({% post_url 2026-03-03-asr-ime-fcitx-v2 %}) 砍掉 Vosk、加 Shift+F8 voice command mode。當時學到的教訓直接影響了 Phase 3 的設計：
