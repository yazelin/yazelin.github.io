...
[拉霸機那篇](https://yazelin.github.io/2026-04-21-emoji-slot-machine/)寫過：用 ASCII diagram 標 A-I 9 個位置 + 在每格 prompt 前面寫 `[A] top-left cell:`，把「位置 ↔ 該畫什麼」鎖死。同時 OUTPUT RULES 顯式寫 `Do NOT render any letter labels (A..I)` 防止字母被烤進圖。
...
跟[拉霸機那篇](https://yazelin.github.io/2026-04-21-emoji-slot-machine/)的結語呼應：
