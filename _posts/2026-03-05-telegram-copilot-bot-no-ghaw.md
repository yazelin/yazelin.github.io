...
[aw-telegram-bot](https://github.com/yazelin/aw-telegram-bot) 用 [gh-aw](https://github.com/github/gh-aw)（GitHub Agentic Workflows）框架驅動，功能很完整。但 gh-aw 是一個額外的框架層，有額外的認識負擔。

這個專案的目標：**做一個功能完全相同、但不依賴 gh-aw 的版本**。直接用 Copilot CLI + Python 腳本，架構更簡單。
...
gh-aw 是好框架 — Safe-Inputs 的沙箱保護、結構化的 Prompt 管理、和 MCP 整合都很成熟。如果你想要更簡單的架構、少一層框架依賴，這個輕量版是功能等價的替代方案。
